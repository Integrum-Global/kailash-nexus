...
| Nexus handler API      | `/apps/kailash-nexus/src/nexus/core.py` (handler/register_handler) |
| Auth dependencies      | `/apps/kailash-nexus/src/nexus/auth/dependencies.py`               |
| Auth plugin            | `/apps/kailash-nexus/src/nexus/auth/plugin.py`                     |
| Tenant context         | `/apps/kailash-nexus/src/nexus/auth/tenant/context.py`             |
| Integration tests      | `/apps/kailash-nexus/tests/integration/test_handler_execution.py`  |
| E2E tests              | `/apps/kailash-nexus/tests/e2e/test_handler_e2e.py`                |
