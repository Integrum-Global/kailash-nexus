...
**File**: `/Users/esperie/repos/dev/kailash_nexus/apps/kailash-nexus/src/nexus/core.py`
...
**File**: `/Users/esperie/repos/dev/kailash_nexus/apps/kailash-nexus/tests/unit/test_core_comprehensive.py`
...
## Files Modified
1. `/apps/kailash-nexus/src/nexus/core.py` - Removed invalid `.stop()` call, added documentation
2. `/apps/kailash-nexus/tests/unit/test_core_comprehensive.py` - Updated test expectations
